...
gcloud functions deploy coraideraccountclaim --gen2 --runtime=go116 --region=europe-west2 --source=gs://raidlogscan_sources/source.zip --entry-point=CoraiderAccountClaim --trigger-topic=coraideraccountclaim
gcloud functions deploy reportaccountclaim --gen2 --runtime=go116 --region=europe-west2 --source=gs://raidlogscan_sources/source.zip --entry-point=ReportAccountClaim --trigger-topic=reportaccountclaim
